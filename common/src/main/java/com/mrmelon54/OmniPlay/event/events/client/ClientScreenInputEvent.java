...
public interface ClientScreenInputEvent {
    ...
    Event<MouseReleased> MOUSE_RELEASED_POST = EventWrapper.of(Inner.MOUSE_RELEASED_POST, mouseReleased -> ((minecraft, screen, v, v1, i) -> EventResult.map(mouseReleased.mouseReleased(minecraft, screen, v, v1, i))));
    Event<MouseDragged> MOUSE_DRAGGED_PRE = EventWrapper.of(Inner.MOUSE_DRAGGED_PRE, mouseDragged -> ((minecraft, screen, v, v1, i, v2, v3) -> EventResult.map(mouseDragged.mouseDragged(minecraft, screen, v, v1, i, v2, v3))));
    Event<MouseDragged> MOUSE_DRAGGED_POST = EventWrapper.of(Inner.MOUSE_DRAGGED_POST, mouseDragged -> ((minecraft, screen, v, v1, i, v2, v3) -> EventResult.map(mouseDragged.mouseDragged(minecraft, screen, v, v1, i, v2, v3))));
    Event<KeyTyped> CHAR_TYPED_PRE = EventWrapper.of(Inner.CHAR_TYPED_PRE, keyTyped -> ((minecraft, screen, c, i) -> EventResult.map(keyTyped.charTyped(minecraft, screen, c, i))));
    Event<KeyTyped> CHAR_TYPED_POST = EventWrapper.of(Inner.CHAR_TYPED_POST, keyTyped -> ((minecraft, screen, c, i) -> EventResult.map(keyTyped.charTyped(minecraft, screen, c, i))));
    Event<KeyPressed> KEY_PRESSED_PRE = EventWrapper.of(Inner.KEY_PRESSED_PRE, keyPressed -> ((minecraft, screen, i, i1, i2) -> EventResult.map(keyPressed.keyPressed(minecraft, screen, i, i1, i2))));
    Event<KeyPressed> KEY_PRESSED_POST = EventWrapper.of(Inner.KEY_PRESSED_POST, keyPressed -> ((minecraft, screen, i, i1, i2) -> EventResult.map(keyPressed.keyPressed(minecraft, screen, i, i1, i2))));
    Event<KeyReleased> KEY_RELEASED_PRE = EventWrapper.of(Inner.KEY_RELEASED_PRE, keyReleased -> ((minecraft, screen, i, i1, i2) -> EventResult.map(keyReleased.keyReleased(minecraft, screen, i, i1, i2))));
    Event<KeyReleased> KEY_RELEASED_POST = EventWrapper.of(Inner.KEY_RELEASED_POST, keyReleased -> ((minecraft, screen, i, i1, i2) -> EventResult.map(keyReleased.keyReleased(minecraft, screen, i, i1, i2))));
